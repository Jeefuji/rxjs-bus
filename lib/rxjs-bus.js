(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["rxjs-bus"] = factory();
	else
		root["rxjs-bus"] = factory();
})(window, function() {
...
var baseHas = __webpack_require__(43),
    hasPath = __webpack_require__(23);
...
var baseIteratee = __webpack_require__(95),
    basePullAt = __webpack_require__(133);
...
var baseUnset = __webpack_require__(134),
    isIndex = __webpack_require__(19);
...
function Bus(name, options) {
    ...
    this.subject = new Subject_Subject();
    ...
    function _on(eventName) {
        return self.subject.pipe(filter(function (o) {
            return o.name === eventName;
        }), tap(function (o) {
            log("[On] => Event " + o.name + " received (" + formatData(o.data) + ")");
        }, error), pluck("data"));
    };
    ...
    function _once(eventName) {
        return self.subject.pipe(filter(function (o) {
            return o.name === eventName;
        }), take(1), tap(function (o) {
            log("[Once] => Event " + o.name + " received (" + formatData(o.data) + ")");
        }, error), pluck("data"));
    };
    ...
    return {
        ...
        once: function once(eventName, callback, options) {
            options = options || {};
            ...
            var s = _once(eventName);

            s = applyOptions(s, options);

            return s.subscribe(callback);
        },
        emit: function emit(eventName, data, options) {
            ...
            if (options) {
                if (options.ack && options.ack.callback) {
                    var id = options.ack.name || v4_default()();
                    var s = _once(id);
...
function BusManager() {
    ...
    var instance = {
        scheduler: scheduler,
        configure: function configure(busList) {
            each_default()(busList.bus, function (c) {
                if (c) {
...
function SmokeBus() {
    return {
        createSmokeBus: function createSmokeBus(emitFn, onFn) {
            return {
                emit: emitFn,
                on: onFn
            };
...
/* harmony default export */ var bus = (new BusManager());
...
function StateRepository(name, options) {
    ...
    return {
        register: function register(eventName, initialState) {
            if (!has_default()(self.subjects, eventName)) {
        ...
        unregister: function unregister(eventName) {
            if (has_default()(self.subjects, eventName)) {
                remove_default()(self.subjects, function (o) {
                    return o === eventName;
                });
                return true;
            }
        ...
        on: function on(eventName, callback, options) {
            ...
            return self.subjects[eventName].on(callback, options);
        },
        once: function once(eventName, callback, options) {
            ...
            return self.subjects[eventName].once(function (o) {
                callback();
                if (o != null) {
        ...
        update: function update(eventName, data) {
            if (self.isCompleted) {
                logger.warn("The event " + self.name + " is actually closed, updating it is impossible.");
                return;
            }
...
function RepositoryManager() {
    ...
    // Public instance
    var instance = {
        configure: function configure(repositories) {
            each_default()(repositories, function (c) {
                if (c) {
                    instance.add(c.name, c.options);
                }
            });
        ...
        add: function add(name, options) {
            if (has_default()(vm.repositories, name)) {
                return;
            }
...
/* harmony default export */ var state = (new RepositoryManager());

// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "BusManager", function() { return bus; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "StateManager", function() { return state; });
